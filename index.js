...
export const burger = {
  ...
  discount: function (string){
    if(string === "student" || string === "teacher"){
     return burger.price = burger.price - burger.price * 0.25;
    }
      else{
       return burger.price = burger.price - burger.price * 0.1;
      }
  }
}
...
*/
reviews.push({name:"Remy", rating: 420, feedback: "Is an actual living legend. A God among mere mortals."});
console.log(reviews);
...
Use the getReviewByIndex function below to do the following:
  ...
  2. The function should return                               the following string: 
